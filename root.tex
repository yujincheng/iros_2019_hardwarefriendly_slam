...
\author{Jincheng Yu$^{1}$, Feng Gao$^{1}$, Jianfei Cao$^{3}$, Chao Yu$^{1}$, Zhaoliang Zhang$^{1}$, Lu Tian$^{2}$, \\ Zhengfeng Huang$^{3}$, Yu Wang$^{1}$ and Huazhong Yang$^{1}$ % <-this % stops a space
