...
\author{Jincheng Yu$^{1}$, Feng Gao$^{1}$, Chao Yu$^{1}$, Lu Tian$^{2}$, Jianfei Cao$^{3}$, Zhaoliang Zhang$^{1}$, \\ Zhengfeng Huang$^{3}$, Yu Wang$^{1}$ and Huazhong Yang$^{1}$ % <-this % stops a space
