...
\title{\LARGE \bf
Data-Efficient and Hardware  Decentralized Monocular Visual {SLAM}
}


\author{Jincheng Yu$^{1}$, Feng Gao$^{1}$, Jianfei Cao$^{1}$, Zhaoliang Zhang$^{1}$ and Yu Wang$^{1}$ % <-this % stops a space
