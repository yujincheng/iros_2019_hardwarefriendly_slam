...
Though NetVLAD consumes huge computation, with the development of FPGA accelerators, we use the embedded CNN accelerator on FPGA \cite{Tech:2019360} to perform NetVLAD for each frame.
We also notice that there are also some previous works regression the 6-D pose directly from the input setero camera \cite{kendall2017end} or monocular camera \cite{Li:2018ca8,Zhan:2018e92}, With the development of CNN.
